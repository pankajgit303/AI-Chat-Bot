      ...
      <div className="relative bg-white dark:bg-slate-900 rounded-2xl shadow-xl w-full max-w-lg border border-slate-200 dark:border-slate-800 overflow-hidden flex flex-col max-h-[90vh]">
          ...
          <div className="space-y-6">
            <div>
              ...
              <p className="text-slate-600 dark:text-slate-400 text-sm leading-relaxed">
                An academic AI chatbot project developed to explore
                conversational AI, API integration, and modern web application
                development. The application uses Google's Gemini API to
                generate intelligent responses and provides a responsive,
            ...
            <div className="bg-slate-50 dark:bg-slate-800/50 rounded-xl p-4 border border-slate-100 dark:border-slate-800">
              ...
              <div className="flex flex-wrap gap-2">
                {[
                  ...
                  <span
                    key={tech}
                    className="px-2.5 py-1 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-md text-xs font-medium text-slate-700 dark:text-slate-300 shadow-sm"
                  >
                    {tech}
                  </span>
                ))}
              ...
              <div className="flex flex-col sm:flex-row items-center sm:items-start gap-5">
                    ...
                    <img
                      ...
                      onError={(e) => {
                        (e.target as HTMLImageElement).src =
                          "https://ui-avatars.com/api/?name=Pankaj+Singha&background=3b82f6&color=fff&size=150";
                      }}
                    />
                  </div>
                </div>
                <div className="space-y-2 text-sm text-slate-600 dark:text-slate-400 border-l-0 sm:border-l-2 border-blue-500 pl-0 sm:pl-4 text-center sm:text-left w-full">
                  ...
                  <p>
                    ...
                    >
                      pankajportfolioo.vercel.app <ExternalLink size={12} />
                    </a>
                  </p>
                  <p>
                    <span className="font-medium text-slate-900 dark:text-slate-200">
        ...
        <div className="p-5 bg-slate-50 dark:bg-slate-800/50 border-t border-slate-200 dark:border-slate-800 text-center">
          <p className="text-xs text-slate-500 dark:text-slate-400">
            Showcase this project on your portfolio to demonstrate full-stack
            and AI integration skills.
          </p>
        </div>
      </div>
    </div>
